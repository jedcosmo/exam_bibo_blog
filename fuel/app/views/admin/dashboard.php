    ...
    <div class="container">
        <div class="row">
               <form action="" method="POST">
                ...
                <div class="form-group row">
                    <label for="firstname" class="col-sm-2 form-control-label">Last Name</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="last_name" id="firstname" placeholder="Last Name">
                    </div>
                </div>
                <div class="form-group row">
